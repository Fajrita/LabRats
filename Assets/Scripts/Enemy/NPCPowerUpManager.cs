...
public class NPCPowerUpManager : MonoBehaviour
{
    ...
    void Start()
    {
        playerMovement = GetComponent<FindTarget>();
        playerAttack = GetComponentInChildren<NPCAttack>();
        playerJump =GetComponent<NPCJump>();
